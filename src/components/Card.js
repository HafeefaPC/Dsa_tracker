            ...
            ans == 0 ? <h6 className=' text-orange-800 italic mt-2 font-sans '>Not Yet Started</h6> :
              Math.round((ans * 100) / qno) != 100 ?
                ...
                <div>      <div className=' justify-between mt-2  text-center flex ' >
                  <h6 className=' rounded-xl  bg-blue-300    pt-1 w-16  text-slate-700 text-xs  ' > STARTED </h6>
                  ...
                  <h6 className='  text-blue-700    ' >{Math.round((ans * 100) / qno)}  %</h6>
                </div>

                  <div className="h-2 rounded-lg  w-full mt-1 bg-blue-300 ">
                    <div className="h-2 rounded-lg bg-blue-500  w-2  "></div>
                  </div>
                </div >
                :
                <div>
                  <div className=' justify-between mt-2  text-center flex ' >
                    <h6 className=' rounded-xl  bg-blue-400    pt-1 w-16  text-slate-700 text-xs  ' > FINISHED </h6>
                    ...
                    <h6 className='  text-blue-700    ' >100%</h6>
                  </div>
                  <div className="h-2 rounded-lg  w-full mt-1 bg-blue-500 ">
                    <div className="h-2 rounded-lg bg-blue-500  w-2   "></div>
                  </div>
                </div>
            // </>
