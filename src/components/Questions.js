  ...
  return (
    <div className={"mb-20"}>
      ...
      <div className='flex justify-center mt-24 ' >
        <img className='w-10 h-10' src={Sparkle}></img>
      ...
      <div className='flex text-center justify-center '>
        <table className='   w-screen mt-20 ml-56  mr-56  '>
          <tr className='  text-amber-50 bg-green-600  text-center'>
          ...
          </tr>
          {
            ...
            qq.map((ele) => {
              {
                return (
                  <tr className={checkID(ele.ID) == true ? "bg-green-400" : ele.ID % 2 === 0 ? "bg-green-100" : "none"}>
